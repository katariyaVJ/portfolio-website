  ...
  return (
    <>
      ...
      >
        <div className="max-w-3xl">
          <div className="kicker">
            ...
            <span className="kicker-text">
              {portfolioSection.sectionKicker}
            </span>
          </div>
        ...
        <Link to="/projects" className="btn-ghost group !px-8 whitespace-nowrap flex items-center">
          <span>{portfolioSection.moreProjectsLabel}</span>
